...
<html xmlns:str="http://exslt.org/strings" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Test Results &mdash; KongaProjectTest</title>
        <style type="text/css">
          html {
            height: 100%
          }
...
<script type="text/javascript">
    ...
    <body>
        <div id="container">
            <div id="header">
                <div class="time" xmlns="">2 m 41 s</div>
                <h1>
                    KongaProjectTest: <strong><span class="total" xmlns="http://www.w3.org/1999/xhtml">6 total, </span><span class="passed">6 passed</span></strong>
                </h1>
                <div id="treecontrol">
                    <ul>
                        <li>
...
Process finished with exit code 0
                    ...
                    <li xmlns="" class="level top open">
                        <span><em class="time">
                                <div class="time">2 m 41 s</div>
                            </em>Konga_Project</span>
                        <ul>
                            <li class="level suite open">
                                <span><em class="time">
                                        <div class="time">2 m 41 s</div>
                                    </em>KongaProjectTest</span>
                                <ul>
                                    <li class="level test">
                                        <span><em class="time">
                                                <div class="time">12.36 s</div>
                                            </em><em class="status">passed</em>KongaProjectTest.LoginPage</span>
                                    </li>
                                    <li class="level test">
                                        <span><em class="time">
                                                <div class="time">34.06 s</div>
                                            </em><em class="status">passed</em>KongaProjectTest.CategoryPage</span>
                                    </li>
                                    <li class="level test">
                                        <span><em class="time">
                                                <div class="time">41.35 s</div>
                                            </em><em class="status">passed</em>KongaProjectTest.AddressSelection</span>
                                    </li>
                                    <li class="level test">
                                        <span><em class="time">
                                                <div class="time">42.55 s</div>
                                            </em><em class="status">passed</em>KongaProjectTest.CardPayment</span>
                                        <ul>
                                            <li class="text">
                                                <span class="stdout">Invalid Card Details<br/>Close pop-up<br/></span>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
        ...
        <div id="footer">
            <p>Generated by IntelliJ IDEA on 7/21/23, 10:15 AM</p>
        </div>
    </body>
</html>
